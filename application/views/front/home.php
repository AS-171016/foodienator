    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            ...
            <div class="carousel-caption text-left">
                <h1 class="display-2">Looking for premium chocolates?!</h1>
        ...
        <div class="carousel-item">
            ...
            <div class="carousel-caption text-right">
                <h1>Craving for chocolate but not the sugar?!</h1>
                <h3>Worry not, just dive into our catalogue</h3>
                <a href="<?php echo base_url().'restaurant/index'?>" class="btn btn-outline-light btn-lg">Order Now</a>
                <a href="<?php echo base_url().'restaurant/index'?>" class="btn btn-primary btn-lg">View Menu</a>
            </div>
        </div>
        <div class="carousel-item">
            ...
            <div class="carousel-caption text-right">
                <h1 class="display-2">Want to gift you special one a memorable gift?</h1>
                <h3>Check out the Occasions tab for more.</h3>
                <a href="<?php echo base_url().'restaurant/index'?>" class="btn btn-outline-light btn-lg">Order Now</a>
                <a href="<?php echo base_url().'restaurant/index'?>" class="btn btn-primary btn-lg">View Menu</a>
            </div>
        </div>
